import socket
from general import *
from networking import Ethernet
from networking import IPv4
from networking import ICMP
from networking import TCP
from networking import UDP
from networking import Pcap
...
class sniff:
    def main(self):
        ...
        if platform.system() == 'Windows':
            ...
            pass
        print('\n')
        file = input("Enter File Name For Save Data: ")
        print('\n')
        pcap = Pcap(file + '.pcap')
        try:
